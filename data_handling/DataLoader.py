...
class AudioCaptionDataset2(Dataset):

    def __init__(self, dataset='AudioCaps', split='train', noise_p=0.1):
        """
        ...
        """
        super(AudioCaptionDataset2, self).__init__()
...
class ESCDataset(Dataset):
    ...
    def __init__(self, dataset='ESC50', split='test', noise_p=0):
        super(ESCDataset, self).__init__()
        self.dataset = dataset
        self.split = split
        self.h5_path = f'data/{dataset}/hdf5s/{split}/{split}.h5'
        self.noise_p = noise_p
